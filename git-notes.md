...
| :-------: | :-----------: | :-------: | :-------------------: | :----------------: |
| workspace |  index/stage  |   stash   |   local repository    | remote repository  |
...
| :----------: | :--------------: | :--------------------------: | :--------------: |
| 版本控制系统 | 基于web的git仓库 |       基于web的git仓库       | 基于web的git仓库 |
|    分布式    |   私人仓库付费   | 私人仓库免费、更多的控制权限 |   服务器在国内   |
...
git reflog              // 历史 git 操作
git show [hash]         // 显示提交内容
...
```
git rebase -i HEAD~3    // p 改 edit 修改提交名称
git commit -amend       // 修改上一次 commit 提交信息（amend：改正、修改）
```
...
| 方法二     | 将本地代码保存在栈区 git stash，拉取远程代码git pull，将栈区代码拉出解决冲突 git stash apply |
| 自己的代码 | <<<<<<<HEAD、=======                                                                        |
| 冲突的代码 | =======、\>>>>>>>                                                                           |
