...
## 文字
~~删除线~~ `~~delete~~` （注意一定是英文下的波浪号）
*斜体* `*italic*`
**加粗** `**bold**`
***斜体加粗*** `***italic and bold***`
&nbsp;空格缩进 `&nbsp;`
<center>居中</center>   
...
## 图片
![图片描述](https://img0.baidu.com/it/u=2098311615,833819932&fm=253&fmt=auto&app=120&f=PNG?w=834&h=608)
...
加粗 `cmd b`
列表项的自动缩进和补全编号
拷贝图像 `cmd opt v`  和自动提示文件内可选图片
提供 latex 公式语法的自动补全 和 创建行内公式 `cmd m`
格式化文档 `opt sft f` (主要用于格式化表格 format)
